"""Tests for the Grub OS Selector agent communication."""
...
from custom_components.grub_os_selector.agent import (
    async_check_agent_status,
...
async def test_async_send_turn_off_command_success(hass: HomeAssistant) -> None:
    ...
    with patch(
        "custom_components.grub_os_selector.agent.async_get_clientsession"
...
async def test_async_send_turn_off_command_unexpected_error(
    ...
    with patch(
        ...
        with (
            patch(
                "custom_components.grub_os_selector.agent.LOGGER.exception"
            ) as mock_log,
...
async def test_async_check_agent_status_success(hass: HomeAssistant) -> None:
...
async def test_async_check_agent_status_invalid_payload(hass: HomeAssistant) -> None:
...
async def test_async_check_agent_status_failure(hass: HomeAssistant) -> None:
